...
#  Target: host.gpurental.jp  →  /www/host/
...
$FTP_REMOTE = "/www/host"          # サブドメイン host.gpurental.jp のドキュメントルート
...
Write-Host ""
Write-Host "================================================"
Write-Host "  GPURental Host LP - FTP Deploy"
...
Write-Host "  URL: https://host.gpurental.jp/"
Write-Host "================================================"
Write-Host ""
