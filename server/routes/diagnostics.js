...
router.post('/gpu', async (req, res) => {
    ...
    if (nodeRes.success) {
        ...
        checks.push({
            ...
            detail: 'GPURentalエージェントの動作にNode.js 18+が必要です',
            fix: {
...
router.get('/server', async (req, res) => {
    const checks = [];
    const siteUrl = process.env.SITE_URL || 'https://gpurental.jp';
    ...
    checks.push({
        ...
        detail: 'GPURentalはCloudflare Tunnelを使用してGPUを公開します',
        fix: cfCheck.ok ? null : {
