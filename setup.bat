@echo off
chcp 65001 > nul
title GPURental Agent Server - Setup
...
if not exist "C:\gpu-rental-main\data\db" (
    mkdir "C:\gpu-rental-main\data\db" 2>nul
    echo [OK] C:\gpu-rental-main\data\db を作成しました
) else (
    echo [OK] C:\gpu-rental-main\data\db が存在します
)
if not exist "C:\gpu-rental-main\data\users" (
    mkdir "C:\gpu-rental-main\data\users" 2>nul
    echo [OK] C:\gpu-rental-main\data\users を作成しました
) else (
    echo [OK] C:\gpu-rental-main\data\users が存在します
)
