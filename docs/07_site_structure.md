# GPURental — サイト構造ドキュメント (Site Map & Architecture)

> **最終更新**: 2026-03-15  
> **開発元**: METADATALAB.INC  
> **リポジトリ**: [github.com/taichiyao333/gpu-rental](https://github.com/taichiyao333/gpu-rental)
...
| リポジトリ | URL | 説明 |
|---|---|---|
| **gpu-rental** (本体) | [github.com/taichiyao333/gpu-rental](https://github.com/taichiyao333/gpu-rental) | メインプラットフォーム |
| **gpurental-saas-kit** | [github.com/taichiyao333/gpurental-saas-kit](https://github.com/taichiyao333/gpurental-saas-kit) | ホワイトラベルパッケージ |
| **gpurental-docker-templates** | [github.com/taichiyao333/gpurental-docker-templates](https://github.com/taichiyao333/gpurental-docker-templates) | GPU環境Dockerファイル集 |
