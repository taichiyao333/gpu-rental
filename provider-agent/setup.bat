...
echo.
echo ╔═══════════════════════════════════════════════╗
echo ║   GPURental - プロバイダーエージェント Setup   ║
...
:: Get email
set /p EMAIL="GPURental アカウントのメールアドレスを入力: "
if "%EMAIL%"=="" (
...
echo.
echo 📝 設定ファイルを作成中...
echo {"platformUrl":"https://gpurental.jp","email":"%EMAIL%","sshHost":"127.0.0.1","sshPort":22} > config.json
